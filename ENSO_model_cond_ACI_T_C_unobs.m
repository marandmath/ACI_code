...
% code uses the same model parameter values as those cited in the following 
% paper: 
...
% [fList, pList] = matlab.codetools.requiredFilesAndProducts('ENSO_model_cond_ACI_T_C_unobs.m');
%
% M-file Scripts:
...
% time_start_plot = ((sim_year_start-obs_start_year)+2)*12*k_dt;
% time_end_plot = ((sim_year_start-obs_start_year)+ACI_period_years-2)*12*k_dt;
% plot(7.5 * T_C(time_start_plot:time_end_plot), time_start_plot:time_end_plot, 'm', Linewidth=2)
% hold on
